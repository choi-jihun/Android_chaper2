...
object SearchRepository {
    ...
    private val retrofit = Retrofit.Builder().baseUrl("https://openapi.naver.com/")
    ...
    class AppInterceptor : Interceptor {
        override fun intercept(chain: Interceptor.Chain): Response {
            val clientId = MYApplication.applicationContext.getString(R.string.X_Naver_Client_Id)
            val clientSecret = MYApplication.applicationContext.getString(R.string.X_Naver_Client_Secret)
