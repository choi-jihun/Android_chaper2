...
import com.example.chapter3_12.R
import com.example.chapter3_12.databinding.ItemVideoBinding
import com.example.chapter3_12.databinding.ItemVideoHeaderBinding
...
class PlayerVideoAdapter(private val context: Context, private val onClick: (PlayerVideo) -> Unit) :
    ...
    inner class HeaderViewHolder(private val binding: ItemVideoHeaderBinding) :
        ...
        fun bind(item: PlayerHeader) {
            ...
            Glide.with(binding.channelLogoImageView).load(item.channelThumb).circleCrop().into(binding.channelLogoImageView)
        }
    }
    ...
    inner class VideoViewHolder(private val binding: ItemVideoBinding) :
        ...
        fun bind(item: PlayerVideo) {
            ...
            Glide.with(binding.channelLogoImageView).load(item.channelThumb)
                .circleCrop().into(binding.channelLogoImageView)
