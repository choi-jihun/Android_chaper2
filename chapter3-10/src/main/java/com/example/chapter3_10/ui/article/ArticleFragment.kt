...
import com.example.chapter3_10.databinding.FragmentArticleBinding
...
class ArticleFragment: Fragment(R.layout.fragment_article) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        Firebase.firestore.collection("articles").document(articleId).get().addOnSuccessListener {
            ...
            Glide.with(binding.thumbnailImageView).load(model?.imageUrl).into(binding.thumbnailImageView)
